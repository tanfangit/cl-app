package com.company.project.weixin.tencent.common.report.service;
...
import com.company.project.weixin.tencent.common.HttpsRequest11;
...
public class ReportService {
    ...
    public String request() throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException {
        String responseString = new HttpsRequest11().sendPost(Configure.REPORT_API, reqData);
    ...
    public static String request(ReportReqData reportReqData) throws Exception {
        ...
        //--------------------------------------------------------------------
        String responseString = new HttpsRequest11().sendPost(Configure.REPORT_API, reportReqData);
