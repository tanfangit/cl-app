package com.company.project.weixin.tencent.protocol.pay_protocol;
...
import com.company.project.weixin.tencent.common.RandomStringGenerator;
...
public class ScanPayReqData {
     ...
     */
    public ScanPayReqData(String authCode,String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String goodsTag,String notify_url){
     ...
     * @param goodsTag 商品标记，微信平台配置的商品标记，用于优惠券或者满减使用
     */
    public ScanPayReqData(String body,String attach,String outTradeNo,int totalFee,String spBillCreateIP,String goodsTag,String notify_url,String trade_type,String openid){
